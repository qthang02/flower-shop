...
(async function addVoucherFail() {
    ...
    const excelFilePath = path.join(__dirname, "addVoucherFail.xlsx");
    let testCases = [];
        ...
        try {
            ...
            if (adminVoucherDetails) {
                ...
                if (adminQuantity === voucherQuantity) {
                    ...
                    testCase.actual = "Thanh toán không thành công do thiếu thông tin ";
                    console.log(testCase.actual);
                } else {
                    testCase.status = "FAIL";
                    testCase.actual = "Vẫn thanh toán thành công dù thiếu thông tin";
                    console.log(testCase.actual);
                }
